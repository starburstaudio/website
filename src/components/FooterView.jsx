...
class FooterView extends React.Component {
  render() {
    return (
      <footer className='bg-base-200 flex flex-col items-center'>
      <div className="all-width footer pt-8">
        All prices listed include VAT, unless stated otherwise. 
      </div>
      <div className="footer py-8 text-base-content all-width">
        <div>
        <span className="footer-title">Products</span> 
          <a className="link link-hover">Sample Packs</a> 
          <a className="link link-hover">Plugins</a> 
          <a className="link link-hover">Free Stuff</a> 
        </div> 
        <div>
      ...
      <div className="footer px-0 py-4 border-t text-base-content border-base-300 all-width">
        ...
        <p><b>Starburst Audio</b><br/>Music production tools, crafted with passion.</p>
        </div> 
