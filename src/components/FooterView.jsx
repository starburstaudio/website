...
class FooterView extends React.Component {
    render() {
        return (
            ...
            <div className="footer p-10 text-base-content all-width">
                <div>
                ...
                <div>
                <span className="footer-title">Meta</span> 
            ...
            <div className="footer px-10 py-4 border-t text-base-content border-base-300 all-width">
